      ...
      <b-card>
          <b-card-title>
              <b-row>
                ...
                <b-col>
                    <b-form-input v-model="Nota.text" placeholder="Agregar nota"></b-form-input>
                </b-col>
                <b-col cols="1">
                    <b-button @click="login()" variant="info">+</b-button>
                </b-col>
              </b-row>
          </b-card-title>
...
export default {
    ...
    methods: {
        ...
        agregarNota: function(){
            axios.post(this.api + '/api/notes', this.Nota)
                .then(res => {
        ...
        eliminarNota: function(row){
            axios.put(this.api + '/api/notes', row)
                .then(res => {
                    console.log(res.data)
                    if (res.status == 200) {
                        this.arraySumplente = []
